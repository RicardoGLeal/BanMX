...
const You = ({ item }) => {
  return item != undefined ? (
    <View style={styles.row_with_margin}>
      <StatProfile
        item={{ place: item.place, user: "Tú", value: item.donations }}
      />
    </View>
  ) : (
    <View style={styles.row_with_margin}></View>
  );
};
    ...
    isYourPosition ? (
      ...
      <View style={styles.row_with_margin}>
        <StatProfile
          item={{
            place: place,
            user: user != undefined ? user : "Anónimo",
            value: value,
          }}
        />
      </View>
  ...
  const renderItem = ({ item }) => {
    return (
      <Item
        ...
        value={item.value}
        isYourPosition={
          item.isYourPosition != undefined ? item.isYourPosition : false
        }
      />
    );
  };
  return (
    <View style={styles.container}>
      ...
      <View style={styles.main_container}>
        ...
        >{`Ayuda a BAMX con su mision de terminar con el 
hambre en mexico. Dona y ve nuestro progreso!`}</Text>
        ...
        <View
          ...
          onTouchEnd={() => navigation.navigate("Donate")}
        >
